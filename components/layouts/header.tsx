  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            "mx-auto flex   justify-between gap-10 items-center transition-all duration-400 ease-in-out px-8 z-50 ",
            isScrolled
              ? "bg-white/80 backdrop-blur-3xl max-w-5xl md:p-6 dark:bg-zinc-900/80  shadow -translate-y-8 md:rounded-3xl"
              : "bg-transparent w-full  max-w-6xl"
          )}
        >
          <div className="flex items-center gap-2">
            <Link href="/">
              <Logo className="size-14 cursor-target" />
            </Link>
          </div>
